...
import ru.fourgotten.VoxileLauncher.Game.GameLauncher;
...
import ru.fourgotten.VoxileLauncher.GUI.FrameLauncherMain;
import ru.fourgotten.VoxileLauncher.GUI.FrameProjects;
import ru.fourgotten.VoxileLauncher.GUI.SplashScreen;
...
import ru.fourgotten.VoxileSecurity.Data.MessagesLauncher.MessageLauncherRun;
import ru.fourgotten.VoxileSecurity.Data.OfflineClient;
import ru.fourgotten.VoxileSecurity.Data.OfflineProject;
import ru.fourgotten.VoxileSecurity.Defaults.DefaultLauncherRun;
...
public class Launcher implements Runnable
{
	...
	public void run()
	{
		...
		try
		{
			final AnswerLauncherProjects msgProjects = MethuselahPrivate.getProjectList();
	...
	public boolean getProjectClients()
	{
		...
		try
		{
			final AnswerLauncherClients msgClients = MethuselahPrivate.getProjectClients(payload);
	...
	public static void main(String[] args)
	{
		instance.run();
		/*
		HashMap<String, String> getProjectClients = new HashMap<String, String>();
		getProjectClients.put("abc", "def");
		byte[] t = ClassFieldExchanger.processBytecodeConstants(Launcher.class.getCanonicalName(), getProjectClients);
		try
		{
